...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel, MainAdapter.myViewHolder> {
     ...
     * @param options
     */
    //se crea el método constructor recomendado
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull MainModel model) {
        ...
        // se setean los valores que se están obteniendo de la base de datos firebease a los componentes layout
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText profile = view.findViewById(R.id.txtProfileURL);
                ...
                profile.setText(model.getProfile());
    ...
    // este es el método titular de la vista
    class myViewHolder extends RecyclerView.ViewHolder{

        CircleImageView img;
        TextView name, course, email;

        //estos botones son los que editan y eliminan
